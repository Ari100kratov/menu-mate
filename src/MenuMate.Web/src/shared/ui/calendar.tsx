  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: cn("relative flex h-9 items-center justify-center", defaultClassNames.month_caption),
        ...
        weekday: cn("text-muted-foreground w-9 text-center text-xs font-normal", defaultClassNames.weekday),
        ...
        range_middle: cn("bg-secondary text-secondary-foreground rounded-none", defaultClassNames.range_middle),
