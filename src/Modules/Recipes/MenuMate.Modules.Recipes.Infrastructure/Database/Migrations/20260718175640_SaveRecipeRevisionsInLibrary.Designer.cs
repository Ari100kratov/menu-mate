...
namespace MenuMate.Modules.Recipes.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260718175640_SaveRecipeRevisionsInLibrary")]
    partial class SaveRecipeRevisionsInLibrary
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MenuMate.Modules.Recipes.Infrastructure.Database.Entities.RecipeLibraryEntryRecord", b =>
                {
                    ...
                    b.Property<Guid>("SavedRevisionId")
                        .HasColumnType("uuid")
                        .HasColumnName("saved_revision_id");
                    ...
                    b.HasIndex("SavedRevisionId")
                        .HasDatabaseName("ix_recipe_library_entries_saved_revision_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_recipe_library_entries_user_id");
            ...
            modelBuilder.Entity("MenuMate.Modules.Recipes.Infrastructure.Database.Entities.RecipeRevisionTagRecord", b =>
                {
                    ...
                    b.HasKey("RecipeRevisionId", "TagId")
                        .HasName("pk_recipe_revision_tags");

                    b.HasIndex("TagId", "RecipeRevisionId")
                        .HasDatabaseName("ix_recipe_revision_tags_tag_id_recipe_revision_id");

                    b.ToTable("recipe_revision_tags", "recipes");
                });

            modelBuilder.Entity("MenuMate.Modules.Recipes.Infrastructure.Database.Source.RecipeMenuItemSourceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MenuMate.Modules.Recipes.Infrastructure.Database.Entities.RecipeLibraryEntryRecord", b =>
                {
                    ...
                    b.HasOne("MenuMate.Modules.Recipes.Infrastructure.Database.Entities.RecipeRevisionRecord", null)
                        .WithMany()
                        .HasForeignKey("SavedRevisionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_recipe_library_entries_recipe_revisions_saved_revision_id");
                });
