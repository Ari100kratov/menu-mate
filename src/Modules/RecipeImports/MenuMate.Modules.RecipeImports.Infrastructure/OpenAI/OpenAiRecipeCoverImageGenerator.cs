        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            string prompt =
                ...
                Используй описание, ингредиенты с количествами и комментариями, шаги приготовления
                и советы из рецепта ниже, чтобы передать форму, цвет, текстуру и степень готовности.
                Покажи готовое блюдо после выполнения всех шагов, а не набор сырых ингредиентов.
                Не добавляй отсутствующие в рецепте гарниры, украшения и ингредиенты.
