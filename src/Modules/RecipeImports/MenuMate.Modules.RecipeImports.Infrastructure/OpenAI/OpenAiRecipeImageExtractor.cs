    ...
    : IRecipeImageExtractor
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            "Неизвестные единицы указывай как Unknown, неизвестные категории как Other. Если указано «щепотка» (в том числе без числа), верни amount=1 и unit=Pinch, а не добавляй «щепотка» в comment. Если для ингредиента не указаны ни количество, ни единица измерения, верни amount=null и unit=ToTaste. Количество порций используй 1, только если оно не указано. " +
