...
ADR — короткие записи архитектурных решений, которые должны переживать потерю контекста переписки.

- [0001 Модульный монолит](0001-modular-monolith.md)
- [0002 Владение данными модулей](0002-data-ownership.md)
- [0003 Теги вместо жестких категорий](0003-tags-over-hard-categories.md) — частично заменено ADR-0014
- [0004 Нормализация ингредиентов](0004-ingredient-normalization.md)
- [0005 Стратегия авторизации](0005-auth-strategy.md)
- [0006 Черновики импорта](0006-import-drafts.md)
- [0007 Локальный запуск через Aspire](0007-aspire-local-launch.md)
- [0008 Отдельный мигратор БД](0008-database-migrator.md)
- [0009 Правила качества и безопасности backend-разработки](0009-backend-quality-security-guardrails.md)
- [0010 Наблюдаемость и Serilog](0010-observability-and-serilog.md)
